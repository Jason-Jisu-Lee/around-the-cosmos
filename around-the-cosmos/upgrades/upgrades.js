...
const UPGRADES = [
    ...
    },
    {
        ...
        unlock: () => lvl('touch') >= 4,                 // after the 4th Star Touch
    },
    {
    ...
    },
    {
        ...
        unlock: () => lvl('grasp') >= 3,                 // alongside Gravitational Pull (after Star Grasp maxed)
    },
    {
    ...
    },
    {
        ...
        desc: () => 'Adds the moon on the widest, slowest orbit. Pays 200 per orbit at base, scaled by its lunar phase (x0.75 at the new moon up to x1.25 at the full). Whatever the payout reads when it completes an orbit is what it pays.',
    ...
    {
        id: 'moonphase', name: 'Lunar Phases', maxLevel: 5, section: 'MOON',  // the moon's unique upgrade
